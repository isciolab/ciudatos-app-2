...
HTML("<img src='img/menu/datosoficiales.png' class = 'imgTab'> 
        <span> Datos oficiales</span>"),
             ...
             div(class="col-xs-12 col-md-9", 
                 ...
                 conditionalPanel(
                   ...
                   #uiOutput('VizObjCif')
                   #uiOutput('VizObjCif2'),
                   div(class="col-md-12",  id = "VizObjCif", style="width: 100%; text-align: center;min-height:400px; height:auto")
  ...
  tabPanel(
    ...
    div( class = 'col-md-9', style="text-align: center;",
         uiOutput('grafIcu'),
    div(class = 'grafICU',
    uiOutput('vizElgICU', width = 900, height = 1000)
    ))
  )),
  tabPanel(
