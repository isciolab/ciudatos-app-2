...
if (!require("datafringe")) devtools::install_github("milevis/datafringe")
if (!require("hgchmagic")) devtools::install_github("milevis/hgchmagic")
if (!require("geojsonio")) install.packages("geojsonio")
if (!require("lfltmagic")) devtools::install_github("milevis/lfltmagic")
